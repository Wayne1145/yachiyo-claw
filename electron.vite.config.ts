...
export function stripUpstreamTelemetry(): Plugin {
  return {
...
export default defineConfig(({ mode }) => {
  ...
  return {
    main: {
      plugins: [
        ...(isProduction
          ? [
              visualizer({
                filename: path.join(bundleStatsDir, 'main.html'),
                open: false,
    ...
    preload: {
      plugins: [
        visualizer({
          filename: path.join(bundleStatsDir, 'preload.html'),
          open: false,
    ...
    renderer: {
      ...
      plugins: [
        ...
        isMobile ? stripUpstreamTelemetry() : undefined,
        visualizer({
