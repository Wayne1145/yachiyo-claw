...
final class ModelDownloadPolicy {
    ...
    private static final Set<String> INITIAL_HOSTS = Set.of("huggingface.co", "hf-mirror.com", "www.modelscope.cn", "modelscope.cn");
    ...
    static void requireAllowedRedirect(URL url) {
        ...
        String host = url.getHost().toLowerCase(Locale.ROOT);
        boolean huggingFace = host.equals("huggingface.co") || host.equals("hf-mirror.com") || host.endsWith(".huggingface.co") ||
