...
import { IconSettingsFilled, IconUser } from '@tabler/icons-react'
import clsx from 'clsx'
import type { FC } from 'react'
import yachiyoAvatar from '../../../../assets/brand/yachiyo-avatar.png'
...
export const AssistantAvatar: FC<AssistantAvatarProps> = ({
  ...
  return (
    <Avatar
      ...
      src={!avatarKey ? picUrl || (!defaultAssistantAvatarKey ? yachiyoAvatar : undefined) : undefined}
      bg="white"
    ...
    >
      {avatarKey ? (
        <ImageInStorage storageKey={avatarKey} className="object-cover object-center w-full h-full" />
      ) : !picUrl && defaultAssistantAvatarKey ? (
