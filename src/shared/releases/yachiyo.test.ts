...
describe('Yachiyo GitHub Releases update check', () => {
  ...
  it('selects the preferred release APK and GitHub digest', async () => {
    ...
    const fetchImpl = vi.fn(async () => new Response(JSON.stringify({
      ...
      assets: [
        { name: 'other.apk', browser_download_url: 'https://github.com/Wayne1145/yachiyo-claw/releases/download/v0.0.5/other.apk', size: 10 },
        { name: 'yachiyo-claw-release.apk', browser_download_url: 'https://github.com/Wayne1145/yachiyo-claw/releases/download/v0.0.5/yachiyo-claw-release.apk', size: 20, digest: `sha256:${digest}` },
      ],
    }), { status: 200 }))
  ...
  it('rejects non-GitHub, cleartext and unrelated release asset URLs', () => {
    expect(isAllowedYachiyoReleaseAssetUrl('https://github.com/Wayne1145/yachiyo-claw/releases/download/v1/app.apk')).toBe(true)
    expect(isAllowedYachiyoReleaseAssetUrl('http://github.com/Wayne1145/yachiyo-claw/releases/download/v1/app.apk')).toBe(false)
    expect(isAllowedYachiyoReleaseAssetUrl('https://example.com/Wayne1145/yachiyo-claw/releases/download/v1/app.apk')).toBe(false)
