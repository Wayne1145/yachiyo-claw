      ...
      submenu: [
        {
          label: 'Learn More',
          click() {
            shell.openExternal('https://github.com/Wayne1145/yachiyo-claw')
          },
        },
        {
          label: 'Github Repo',
        ...
        // },
        {
          label: 'Search Issues',
          click() {
            shell.openExternal('https://github.com/Wayne1145/yachiyo-claw/issues')
          },
        },
      ],
    }
